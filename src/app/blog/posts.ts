...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      "None of this is exotic. It's the same technical and content discipline any good SEO program uses — just pointed at a different kind of buyer, with a different definition of what winning looks like. Six months of doing this consistently for one accounting firm moved them from position 30 into the top 10 search results for their target keywords, and doubled their impressions and clicks. They're now booking new clients weekly, not just at tax time.",
